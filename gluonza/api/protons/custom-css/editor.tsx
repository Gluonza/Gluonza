  ...
  return (
    <svg className="tabbar-icon" width={30} height={30} viewBox="0 0 961.0625 429" id="svg3059">
      <defs id="defs3061">
        ...
        <linearGradient x1="464.315" y1="532.26703" x2="464.315" y2="108.459" id="linearGradient3057" xlinkHref="#SVGID_1_" gradientUnits="userSpaceOnUse" gradientTransform="matrix(1,0,0,-1,-110.8195,852.7348)"/>
      </defs>
